...
def compute_target_angle(list_link_lengths, list_joint_angles, target_position):
    ...
    current_joint_angles = [torch.tensor(list_joint_angles[i], requires_grad=True) for i in range(len(list_joint_angles))]
...
def collect_sequence_data(data_id, screen_width, screen_height, data_dir, disable_window=True):
    ...
    robot = reach.SimpleRobot([12., 12., 12., 12., 12.])
...
if __name__ == '__main__':
    screen_width = 128
    screen_height = 128
    data_dir = './data_position_3_joints_12_12_12_12_12_2000/'
