import numpy as np
from models.backbone_full_cortex import Backbone
...
def train(writer, name, epoch_idx, data_loader, model, 
    ...
    for idx, (img, joints, task_id, end_position, object_list, target_position, next_joints, displacement) in enumerate(data_loader):
        ...
        # Forward pass
        optimizer.zero_grad()
        action_pred, target_position_pred, displacement_pred, attn_map, attn_map2, joints_pred, task_pred = model(img, joints, task_id)
...
if __name__ == '__main__':
    # Debussy
    name = 'train13-2-full-cortex-supervised-attn-curriculum-bs128'
