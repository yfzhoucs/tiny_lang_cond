...
class Backbone(nn.Module):
    ...
    def forward(self, img, joints, target_id, attn_mask=None, target_pos_embed=None):
        ...
        if target_pos_embed is not None:
            state_embedding[:,0,:] = target_pos_embed
        ...
        if self.add_displacement:
            ...
            return action_pred, target_position_pred, displacement_pred, attn_map, attn_map2, attn_map3, attn_map4, joints_pred, state_embedding[:, 0, :]
